...
def test1():
    test_cases=[[-9,2,-5,-4,6],
                ...
                [9,-2,1,-7,-8],
                [15,-2,-5,-4,16],
                [7,-5,6,7,-7]]           # Definimos una lista con los vectores de prueba que consisten en arreglos de números enteros.

    for vector  in test_cases:                                 # Iteramos a través de los casos de prueba.
...
def test2():
    vectores_aleatorios = [aleatorio(9) for _ in range(9)]    # Generamos una lista de 9 vectores aleatorios utilizando la función aleatorio(n) que nos proporciona un vector de n elementos con valores desde n hasta -n [-n,...,n], necesitamos 10 vectores así, por lo que usamos el for _ in range(9) (0.....9)

    for vector in vectores_aleatorios:                                 # Iteramos a través de los vectores aleatorios
        result_algo1 = sumaSubMax1(vector)                             # Calculamos la suma máxima usando el Algoritmo 1
        result_algo2 = sumaSubMax2(vector)                             # Calculamos la suma máxima usando el Algoritmo 2
        imprimirVector(vector , result_algo1, result_algo2)             # Llamamos a la función auxiliar que nos imprimirá cada vector.
