...
def calcular_tiempo_ejecucion(n, orden):    # Medir el tiempo de ejecución de una función (que representa un algoritmo) cuando se le proporciona un vector como entrada
    import time
...
def calcular_tiempo_promedio(repeticiones_umbral, n, orden):    # Realizar repeticiones de inicialización + algoritmo K veces, es decir, repetir el cálculo del algoritmo K veces y para eso necesitas inicializar el vector K veces también, sino inicializas el vector, el algoritmo siempre iteraría las K veces sobre el vector ordenado
   import time
...
def calcular_tiempo_ejecucion_ordenacionPorMonticulos(n, orden):    # Medir el tiempo de ejecución de una función (que representa un algoritmo) cuando se le proporciona un vector como entrada
    import time
    vector = inicializar(n,orden)  # Puedes usar el vector aleatorio como entrada
...
def calcular_tiempo_promedio_ordenacionPorMonticulos(repeticiones_umbral, n, orden):    # Realizar repeticiones de inicialización + algoritmo K veces, es decir, repetir el cálculo del algoritmo K veces y para eso necesitas inicializar el vector K veces también, sino inicializas el vector, el algoritmo siempre iteraría las K veces sobre el vector ordenado
   import time
